...
export const FileUpload = ({
  ...
  return (
    <div className="w-full bg-black" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        ...
        <div className="flex flex-col items-center justify-center">
          <p
            className="relative z-20 font-sans font-bold text-neutral-300 text-5xl mb-4">
            Upload file
          </p>
          <p
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-gray-800 dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
...
export function GridPattern() {
  ...
  return (
    <div
      className="flex  bg-slate-400 shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
            ...
            <div
              ...
              className={`w-10 h-10 flex shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ...
                  : "bg-black dark:bg-neutral-950 shadow-[0px_0px_1px_3px_rgba(0, 0, 0, f)_inset] dark:shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
              }`} />
          );
        }))}
    </div>
